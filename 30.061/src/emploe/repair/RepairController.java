...
public class RepairController implements Initializable {
    ...
    public ObservableList<Repair> getRepairList(){
        ...
        try {
            ...
            Repair Repair;
            while (rs.next()){
                Repair = new Repair(rs.getInt("id_repair"), rs.getString("date_beginning"), rs.getString("rcustumer"),
    ...
    public void showRepair(){
        ...
        tcdate.setCellValueFactory(new PropertyValueFactory<Repair, String>("date_beginning"));
    ...
    private void deleteButton(){
        String query = "DELETE FROM repair WHERE id_repair = " + Integer.parseInt(tfid.getText()) + " ";
        executeQuery(query);
        showRepair();
    }
    ...
    private void handleMouseAction(MouseEvent event) {
        ...
        tfdate.setText(Repair.getDate_beginning());
